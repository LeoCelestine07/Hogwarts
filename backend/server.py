...
DEFAULT_SITE_CONTENT = {
    ...
    # Projects Page
    "projects_page_badge": "Our Portfolio",
    "projects_page_title": "Featured",
    "projects_page_title_gradient": "Projects",
    "projects_page_subtitle": "Explore our collection of completed works across films, music, documentaries, and multimedia productions.",
