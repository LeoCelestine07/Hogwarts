  ...
  return (
    <div className="relative min-h-screen" data-testid="projects-page">
      ...
      <div className="fixed inset-0 bg-[#030305] -z-10">
        ...
        <div className="absolute top-1/2 left-1/3 w-[600px] h-[600px] bg-purple-500/5 rounded-full blur-[200px]" />
      </div>
      ...
      <section className="pt-40 pb-16 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <span className="inline-block px-4 py-2 rounded-full glass border border-white/10 text-xs uppercase tracking-[0.2em] text-purple-400 mb-6">
              Our Portfolio
            </span>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[300px] md:auto-rows-[350px]">
              {filteredProjects.map((project, index) => {
                // Make first project larger (bento style)
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute inset-0">
                      {/* 
                        PLACEHOLDER IMAGE - Easy to replace:
                        Just update the 'image_url' field in the database or admin panel
                      */}
                      <img 
                    ...
                    <div className="absolute top-6 left-6">
                      <span className="px-4 py-2 rounded-full glass-heavy border border-white/20 text-xs uppercase tracking-wider text-cyan-400">
                        {project.work_type}
                      </span>
                    </div>
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                      <div className="w-16 h-16 rounded-full glass-heavy border border-white/30 flex items-center justify-center hover:scale-110 transition-transform cursor-pointer">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            {[
              ...
              { value: '25+', label: 'Films Dubbed' },
              { value: '100+', label: 'Hours Mixed' },
